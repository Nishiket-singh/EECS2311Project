...
public class Sports {
	...
	public static final List<String> article = Arrays.asList("What week of joy and happiness! Friends, there are a few  pieces of joy that were brought forth through ice, the pool and on the mats. I'm brimming with excitement about the following stories. I will start with the Toronto Six winning the PHF championship last Sunday. Not only was the Isobel Cup game a nail-biter that went into OT, it was a moment for Canadian women's hockey to be proud of. Over the last few years, I have attended a number of Toronto Six games and the crowds have grown to a committed fan base and the vibe is excellent.\r\n"
			+ "\r\n"
			...
			+ "\r\n"
			+ "The fact that she isn't shying away from addressing mental health struggles and needing to adapt her schedule to it, may be helping other athletes. Healing for each person is different and I'm grateful that she invested in herself.I saw a great segment on CBC Kids with Skylar Park, the Taekwondo phenom from Winnipeg. Park explains the history and culture of Taekwondo. It's a fun segment and her energy is infectious.\r\n"
			+ "\r\n"
			...
			+ "There are a few women in the Greater Toronto Area and in other cities across Canada who prepare premium chocolate covered dates, stuffed dates and date truffles. Dates have been traditional used in sticky toffee pudding but this newer trend to stuff them with nuts or coat them in chocolate is one of my favourite things. When you have been fasting all day, to be able to taste this rich, delicious date combined with nuts are not only packed with protein but a delight and treasure for the tastebuds.","Russian and Belarusian players will be able to compete at Wimbledon as neutral athletes after the All England Club on Friday reversed its ban from last year.The players must sign declarations of neutrality and comply with “appropriate conditions,” including not expressing support for Russia's invasion of Ukraine. “This was an incredibly difficult decision, not taken lightly or without a great deal of consideration for those who will be impacted,” All England Club chairman Ian Hewitt said in a statement.\r\n"
					...
					+ "\r\n"
					+ "The same conditions will apply for Lawn Tennis Association tournaments used by players as grass-court warmups for the sport’s oldest Grand Slam tournament. The women’s and men’s professional tennis tours last year imposed heavy fines on the LTA and threatened to pull its tournaments. The effect of being expelled from the tours, the LTA said, “would be very damaging and far reaching for the game in our country.”\r\n"
					+ "\r\n"
					...
					+ "\r\n"
					+ "“It has taken a collaborative effort across the sport to arrive at a workable solution, which protects the fairness of the game,” the tours said. “This remains an extremely difficult situation, and we would like to thank Wimbledon and the LTA for their efforts in reaching this outcome, while reiterating our unequivocal condemnation of Russia’s war on Ukraine.”","The Boston Bruins completed the formality of clinching the Presidents’ Trophy on Thursday night with an overtime win over the Blue Jackets, and they’ve already made some NHL history and aim to break another record or two before the season wraps.\r\n"
							+ "\r\n"
							+ "The 2022-23 Bruins already became the fastest NHL team to 50 wins (in 64 games) and 100 points (in 61 contests). Entering Saturday with a 58-12-5 record and 121 points with seven games remaining, the Bruins are still in reach of setting new NHL regular-season records for wins and points.\r\n"
							+ "\r\n"
							+ "Let’s consider their chances and how the 2022-23 Bruins stack up against the greatest NHL teams of all-time. Already at 58 wins, the Bruins need to win four of their last seven games to reach 62 victories, which would tie them with the 1995-96 Detroit Red Wings and 2018-19 Tampa Bay Lightning. They’d stand alone if they reached 63-plus victories by winning at least six of those contests. Since we last checked in on the Bruins’ historic regular season, the team’s slowed down ever so slightly — but really only by their outrageous standards. This relative slippage hasn’t derailed their dreams of tying or breaking the wins record, but it makes the points mark a bigger leap. With 121 points in 75 games played, the Bruins are basically on pace (if you round up) to match the 1976-77 Montreal Canadiens’ record of 132 points. It should be mentioned, however, the Canadiens accomplished that in only 80 games and without the benefit of shootouts, from which the Bruins have compiled three wins and nine points this season.  ");
}